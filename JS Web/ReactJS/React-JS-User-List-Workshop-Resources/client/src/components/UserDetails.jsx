...
export default function UserDetails(props) {
    ...
    useEffect(() => {
        ...
        async function getData() {
            try {
                setIsLoading(true);
                const response = await requests.getOneUser(props.userDetails);

                const createdDate = new Date(response.createdAt);
                response.createdAt = createdDate.toLocaleDateString("en-US", {
                    year: "numeric",
                    month: "long",
                    day: "numeric",
                    weekday: "long"
                ...
                response.updatedAt = updatedDate.toLocaleDateString("en-US", {
                    year: "numeric",
                    month: "long",
                    day: "numeric",
                    weekday: "long"
            ...
            <div className="modal">
                <div className="detail-container">
                    <header className="headers">
                        <h2>User Detail</h2>
                        <button onClick={() => props.setUserDetails('')} className="btn close">
