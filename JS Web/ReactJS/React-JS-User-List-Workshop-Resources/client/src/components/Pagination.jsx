export default function Pagination(props) {
    ...
    const usersLength = props.totalUsers;
    const itemsPerPage = props.itemsPerPage;
    const lastPage = Math.ceil(usersLength / itemsPerPage);

    let currentPage = props.currentPage;
    let disablePrevPage = false;
    let isLastPage = false;

    let lastPageTotalUsers = itemsPerPage * currentPage;
    ...
    if (currentPage === lastPage) {
        isLastPage = true;
        lastPageTotalUsers = usersLength;
    }
    ...
    return (
        <div className="pagination position">
            <div className="limits">
                ...
                <select name="limit" className="limit" defaultValue={itemsPerPage} onChange={(e) => props.setItemsPerPage(Number(e.target.value))}>
            ...
            <p className="pages">{itemsPerPage * currentPage - (itemsPerPage - 1)} - {lastPageTotalUsers} of {usersLength}</p>
            <div className="actions">
                <button disabled={disablePrevPage} onClick={() => props.setCurrentPage(1)} className="btn" title="First Page">
                ...
                <button disabled={disablePrevPage} onClick={() => props.setCurrentPage(prevPage => prevPage - 1)} className="btn" title="Previous Page">
                ...
                <button disabled={isLastPage} onClick={() => props.setCurrentPage(prevPage => prevPage + 1)} className="btn" title="Next Page">
                ...
                <button disabled={isLastPage} onClick={() => props.setCurrentPage(lastPage)} className="btn" title="Last Page">
