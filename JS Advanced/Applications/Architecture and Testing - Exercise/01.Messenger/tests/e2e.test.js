...
describe('E2E tests', function () {
  ...
  describe('Messenger Info', () => {
    ...
    it('Send Message API call', async () => {
      ...
      await page.fill('input[name="author"]', 'Author test');
      await page.fill('input[name="content"]', 'Message test');
      ...
      expect(postData.author).to.equal('Author test');
      expect(postData.content).to.equal('Message test');
    });
  });
});
