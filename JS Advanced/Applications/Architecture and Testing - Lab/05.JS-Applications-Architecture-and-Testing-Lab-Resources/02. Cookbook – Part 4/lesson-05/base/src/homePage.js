...
export async function homePage() {
    ...
    let catalogLink = homePage.querySelector('a[href="/catalog"]');

    const newLink = catalogLink.cloneNode(true);
    catalogLink.replaceWith(newLink);
    catalogLink = newLink;
    ...
    const recentRecipes = homePage.querySelector('.recent-recipes');
    recentRecipes.innerHTML = '';

    const url = 'http://localhost:3030/data/recipes?select=_id%2Cname%2Cimg&sortBy=_createdOn%20desc&pageSize=3';
    ...
    `;
        ...
        article.addEventListener('click', async () => {
            ...
            articleRecipes.style.display = 'block';
        ...
        recentRecipes.appendChild(article);
    })
}
